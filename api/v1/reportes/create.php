...
if (!isset($data->bano_id)) {
    http_response_code(400);
    echo json_encode(['error' => 'bano_id es requerido']);
    exit();
}
...
$urgencia = null;
if (isset($data->urgencia) && $data->urgencia !== null && $data->urgencia !== '') {
...
try {
    ...
    // Actualizar ultimo_reporte_fecha
    ...
    echo json_encode([
        'success' => true,
        'message' => 'Reporte creado exitosamente. El administrador lo revisará.',
